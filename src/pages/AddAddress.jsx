...
const Address = () => {
  ...
  useEffect(() => {
    // previously this redirected unauthenticated users back to the cart
    // which prevented opening the Add Address page. Remove the auto-redirect
    // so users can add an address even if not logged in.
  }, [user]);
  return (
